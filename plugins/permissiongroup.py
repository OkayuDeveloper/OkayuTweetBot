...
__plugin_usage__ = r"""
    权限管理插件
"""
@on_command('legalGroupList1',aliases=['合法权限组列表1'],permission=perm.SUPERUSER,only_to_me = True)
...
@on_command('legalPermList1',aliases=['合法权限列表1'],permission=perm.SUPERUSER,only_to_me = True)
...
def perm_GroupListToStr(grouplist):
    ...
    return msg
@on_command('permGroupList1',aliases=['权限组列表1'],permission=perm.SUPERUSER,only_to_me = True)
...
def perm_GroupToStr(groupname,PermList,info = None):
    ...
    return msg
@on_command('permList1',aliases=['权限列表1'],permission=perm.SUPERUSER,only_to_me = True)
...
@on_command('permAdd1',aliases=['添加权限1'],permission=perm.SUPERUSER,only_to_me = True)
...
@on_command('permDel1',aliases=['移除权限1'],permission=perm.SUPERUSER,only_to_me = True)
